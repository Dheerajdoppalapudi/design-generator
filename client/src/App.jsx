      ...
      <div>
        <Title level={3} style={{ color: 'white', margin: 0 }}>
          <Link to="/" style={{ color: 'white', textDecoration: 'none' }}>
            <span style={{ fontWeight: 300 }}>Design</span><span style={{ fontWeight: 600 }}>Gen</span>
          </Link>
        </Title>
      </div>
...
const SidebarComponent = () => {
  ...
  const sidebarStyle = {
    background: isDarkMode ? 'rgba(0, 21, 41, 0.8)' : 'rgba(255, 255, 255, 0.8)',
    overflow: 'auto',
    height: '100vh',
    position: 'fixed',
    left: 0,
      ...
      <Layout style={{ minHeight: '100vh' }}>
        ...
        <Layout style={{ 
          ...
          <Footer style={{ 
            ...
            Design Generator ©{new Date().getFullYear()} - Your Design Creation Solution
          </Footer>
        </Layout>
      </Layout>
    </Router>
